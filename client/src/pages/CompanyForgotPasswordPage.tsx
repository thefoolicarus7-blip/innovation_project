...
import { forgotCompanyPasswordApi } from "../services/api";
...
export function CompanyForgotPasswordPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const data = await forgotCompanyPasswordApi(email.trim());
      setStatus("success");
        ...
        <section className="auth-card-wrap" style={{ gridColumn: "1 / -1" }}>
          ...
          >
            <div className="form-header">
              <h1>Employer Password Reset</h1>
              <p>
                Enter the email address linked to your employer account and we will
